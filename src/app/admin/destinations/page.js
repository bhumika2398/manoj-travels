      ...
      <div className="p-4 md:p-8">
        <AdminCard>
          <p className="mb-5 text-sm text-gray-500">
            ...
            <code className="rounded bg-gray-100 px-1 py-0.5 text-[13px]">src/data/destinations.js</code>. Only add
            destinations that have a real image already uploaded to{" "}
            <code className="rounded bg-gray-100 px-1 py-0.5 text-[13px]">public/images/destinations/</code>.
          </p>
