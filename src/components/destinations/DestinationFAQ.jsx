...
export function buildDestinationFaqs(destination) {
  return [
    {
    ...
    {
      question: `Do you also provide a cab from ${destination.name} back to Bangalore?`,
      answer: `Yes, we operate ${destination.name} to Bangalore taxi services as well as Bangalore to ${destination.name} — call or WhatsApp us with your pickup point and travel date.`,
    },
    {
...
export function DestinationFAQ({ destination }) {
  return <Accordion items={buildDestinationFaqs(destination)} />;
}
