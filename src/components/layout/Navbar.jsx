...
export function Navbar() {
  ...
  return (
    <header
      className={cn(
        "glass-nav fixed inset-x-0 top-0 z-50 transition-shadow duration-500 ease-out",
    ...
    >
      ...
      >
        ...
        {/* margins around it. Always legible on every page, light or dark   */}
        {/* hero alike, thanks to the glass-nav surface behind it.           */}
        <Logo tone="dark" size="md" compactOnMobile className="shrink-0" />
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          ...
          <a
            href={callLink()}
            className="hidden shrink-0 items-center gap-1.5 whitespace-nowrap rounded-[var(--radius-full)] px-1.5 py-2 text-[15px] font-medium text-[var(--color-ink)] transition-colors hover:text-[var(--color-accent-2)] lg:flex"
          >
          ...
          {/* The premium pill CTA — built standalone rather than through the
              ...
              the safe way to get a genuinely pill-shaped glass button. */}
          <Link
            href="/fleet"
          ...
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-[var(--color-line-accent)] text-[var(--color-ink)] transition-colors hover:bg-[var(--color-paper-2)] sm:hidden"
          >
          ...
          <a
            ...
            className="glass-light flex h-10 w-10 items-center justify-center rounded-full text-[var(--color-accent-2)] transition-transform hover:scale-105 sm:hidden"
          >
          ...
          <button
            ...
            className="flex h-11 w-11 items-center justify-center border border-[var(--color-line-accent)] text-[var(--color-ink)] transition-colors hover:bg-[var(--color-paper-2)] lg:hidden"
          >
